...
Namespace DXSample
	Friend Class IsDaysInterval
		...
		Public Function IsValidOperandType(ByVal operandIndex As Integer, ByVal operandCount As Integer, ByVal type As Type) As Boolean
			Return operandIndex = 0 AndAlso type Is GetType(DateTime) OrElse operandIndex = 1 AndAlso type Is GetType(Integer)
		End Function
		...
		Public Function Evaluate(ParamArray ByVal operands() As Object) As Object
			...
			Dim start As DateTime = DateTime.Today.AddDays(-days)
			Dim [end] As DateTime = DateTime.Today.AddDays(days)
